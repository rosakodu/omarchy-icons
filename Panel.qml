...
Panel {
    ...
    function applyTheme(themeName) {
        ...
        var script = 'THEME="$0"; '
            ...
            + 'make_alias "org.kde.dolphin" "dolphin"; '
            + 'make_alias "dolphin" "org.kde.dolphin"; '
            + 'make_alias "org.kde.krita" "krita"; '
            + 'make_alias "calligrakrita" "krita"; '
            + 'make_alias "calligrakrita" "org.kde.krita"; '
            + 'make_alias "org.gnome.Nautilus" "nautilus"; '
            + 'make_alias "org.gnome.Nautilus" "file-manager"; '
            + 'make_alias "nautilus" "org.gnome.Nautilus"; '
            + 'make_alias "file-manager" "org.gnome.Nautilus"; '
            + 'make_alias "file-manager" "nautilus"; '
            + 'make_alias "com.discordapp.Discord" "discord"; '
            + 'make_alias "discord" "com.discordapp.Discord"; '
            + 'make_alias "ru.linux_gaming.PortProtonQt" "portproton"; '
            + 'make_alias "ru.linux_gaming.PortProtonQt" "PortProtonQt"; '
