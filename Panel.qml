...
Panel {
    ...
    function applyTheme(themeName) {
        ...
        var script = 'THEME="$0"; '
            ...
            + 'make_alias "google-chat" "google-messages"; '
            + 'make_alias "messaging-app" "google-messages"; '
            + 'make_alias "org.gnome.Messages" "google-messages"; '
            + 'make_alias "android-messages-desktop" "google-messages"; '
            + 'make_alias "chat.delta.desktop" "google-messages"; '
